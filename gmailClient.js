...
const CREDENTIALS_PATH = require('./config/config').CREDENTIALS_PATH;
const TOKEN_PATH = require('./config/config').TOKEN_PATH;
const mailVersion = require('./config/config').MAIL_VERSION;
...
function getGmailClient() {
    ...
    return google.gmail({version: mailVersion, auth: oauthClient});
}
